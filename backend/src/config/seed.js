...
async function seed() {
  try {
    ...
    logger.info('Seed complete. Admin: admin@example.com — retrieve password from seed source.');
    logger.info('Seed complete. Users: alice@example.com, bob@example.com — retrieve passwords from seed source.');
    process.exit(0);
  } catch (err) {
